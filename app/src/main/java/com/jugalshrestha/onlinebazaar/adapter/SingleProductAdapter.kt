package com.jugalshrestha.onlinebazaar.adapter
...
import com.jugalshrestha.onlinebazaar.Notifications.Notification
import com.jugalshrestha.onlinebazaar.R
import com.jugalshrestha.onlinebazaar.entity.Product
import com.jugalshrestha.onlinebazaar.repository.CartRepository
...
class SingleProductAdapter (
    ...
    override fun onBindViewHolder(holder: SingleProductViewHolder, position: Int) {
        ...
        val imguri = "http://192.168.1.136:90/" + product.product_img!!.replace("\\", "/")
